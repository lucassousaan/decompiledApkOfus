...
public abstract class f {
    ...
    public static final ThreadLocal f2428a = new ThreadLocal();

    /* renamed from: b  reason: collision with root package name */
    public static final ThreadLocal f2429b = new ThreadLocal();

    public static void c(ViewGroup parent, View descendant, Rect rect) {
        ThreadLocal threadLocal = f2428a;
        ...
        ThreadLocal threadLocal2 = f2429b;
